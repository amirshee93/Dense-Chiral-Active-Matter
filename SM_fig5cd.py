...
ax1.plot(x1[::10], x2[::10], marker = '^', color='k', markersize=6, linestyle='None', label='$\Omega\pm 0\% \Omega$')
...
file_path0 = f"../../binary_mixtures/heterogeneous/omega/vel_autocorr_sim/poly_0.2/"
x1, x2 = read_two_column_file(file_path0 + "velocity_autocorrelation.txt")
ax1.plot(x1[::10], x2[::10], marker = 's', color='b', markersize=6, linestyle='None', label='$\Omega\pm 20\% \Omega$')



df = pd.read_csv("../../binary_mixtures/heterogeneous/omega/dynamics/poly_0.2/omegas_data.csv")
...
file_path0 = f"../../binary_mixtures/heterogeneous/omega/vel_autocorr_sim/poly_0.4/"
x1, x2 = read_two_column_file(file_path0 + "velocity_autocorrelation.txt")
ax1.plot(x1[::10], x2[::10], marker = 'o', color='r', markersize=6, linestyle='None', label='$\Omega\pm 40\% \Omega$')


df = pd.read_csv("../../binary_mixtures/heterogeneous/omega/dynamics/poly_0.4/omegas_data.csv")
omegas = df['Omega'].values
...
ax1.text(-0.15, 1.02, '(c)', transform=ax1.transAxes, fontsize=fontsize, fontweight='bold', va='top')
...
file_path0 = f"../../binary_mixtures/heterogeneous/omega/vel_corr_sim/poly_0.2/"
x1, x2 = read_two_column_file(file_path0 + "vel_corr.txt")
x1 = np.array(x1)
x2 = np.array(x2)
sort_indices = np.argsort(x1)
...
file_path0 = f"../../binary_mixtures/heterogeneous/omega/vel_corr_sim/poly_0.4/"
x1, x2 = read_two_column_file(file_path0 + "vel_corr.txt")
x1 = np.array(x1)
x2 = np.array(x2)
sort_indices = np.argsort(x1)
...
ax2.text(-0.15, 1.02, '(d)', transform=ax2.transAxes, fontsize=fontsize, fontweight='bold', va='top')
